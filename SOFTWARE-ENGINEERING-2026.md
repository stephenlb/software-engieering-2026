...
also it's useful to use a proper GU8 diff viewer to let code suggest edits
...
Each of the following are separate prompts in a workflow:
 ...
 - Prompt AI to 
 - Review Code to ensure that it actually impemented
